                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="code_premi" id="code_premi" value="0210" readonly
                                                    class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="premi_1" id="premi1" value="{{old('premi_1')}}" class="form-control" placeholder="Rp.">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="premi2"> Wilayah II *</label>
                                                <input type="number" name="premi_2" id="premi2" value="{{old('premi_2')}}" class="form-control" placeholder="Rp.">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="premi3">Wilayah III *</label>
                                                <input type="number" name="premi_3" id="premi3" value="{{old('premi_3')}}" class="form-control" placeholder="Rp.">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="cost"> Cost Premi *</label>
                                                <input type="number" name="cost_premi" id="cost" value="{{old('cost_premi')}}" class="form-control" placeholder="Rp.">
