                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="no_polisi" class="form-control" id=""
                                    value="{{old('no_polisi')}}" placeholder="Nomor Polisi..">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="">Nomor Rangka *</label>
                                <input type="text" name="no_rangka" class="form-control" id=""
                                    value="{{old('no_rangka')}}" placeholder="No Rangka..">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="">Nomor Mesin *</label>
                                <input type="text" name="no_mesin" class="form-control" id=""
                                    value="{{old('no_mesin')}}" placeholder="Nomor Mesin..">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="">Total Perlengkapan Non Standard *</label>
                                <input type="text" name="harga_total_perlengkapan_non_standar" class="form-control"
                                    id="" value="{{old('harga_total_perlengkapan_non_standar')}}"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="harga_kendaraan" class="form-control" id=""
                                    value="{{old('harga_kendaraan')}}" placeholder="Price..">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="nama_agen" class="form-control" id=""
                                    value="{{old('nama_agen')}}">
                            </div>
                        </div>
                        <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group-btn">
                                        <span class="fileUpload btn btn-info">
                                            ...
                                            <input type="file" name="berkas[]" class="upload up" id="up"
                                                value="{{old('berkas[]')}}" onchange="readURL(this);" multiple />
                                        </span>
                                    </div>
                                </div>
                            </div>
