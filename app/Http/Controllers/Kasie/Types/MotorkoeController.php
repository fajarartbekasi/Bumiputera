...
class MotorkoeController extends Controller
{
    ...
    public function dataTableMotorKoe()
    {
        ...
        return Datatables::of($hubungkanTypeDenganPremisTable)
                    ...
                    return '
                       <button class="btn btn-xs btn-outline-danger btn-delete" data-remote="http://Bumiputera.test/public/kasie/hapus/type/premi/' . $typePremis->id . '">
                          <i>
                       ...
                       <a href="http://Bumiputera.test/public/kasie/formulir/edit-data/'.$typePremis->id.'" class="btn btn-xs btn-primary"/>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" width="20" height="20">
